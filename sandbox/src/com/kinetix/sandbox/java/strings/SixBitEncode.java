...
public class SixBitEncode {
    ...
    public static void main(String[] args) {
        ...
        SixBitEncode encoder = new SixBitEncode();
        byte[] encodedResult = encoder.encode(testStr, SIX_BIT);
        String encodedStr = null;
        try {
            encodedStr = new String(encodedResult, 0, encodedResult.length, "UTF-8");
