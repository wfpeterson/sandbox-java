package com.kinetix.sandbox.java.filetypeidentifier;
...
public enum ImageFormat 
{
	...
	MOV("video/mov", "Quicktime Video", null, false, "MOV"),
	MP4("video/mp4", "Video MPEG4", null, false, "MP4");
	...
	ImageFormat(String mimeType, String description, String enclosedMimeType, 
			boolean compressed, String extension)
	{
		this.mime = mimeType;
